  ...
  return (
    <Container>
      ...
      <SocialMedia>
        ...
        >
          <SocialMediaIcon name="twitter" size={40} color="#ffffffbd" />
        </SocialMediaEntity>
        <SocialMediaEntity
          testID="web-icon"
          onPress={() => Linking.openURL(user.website)}
        >
          <SocialMediaIcon2 name="web" size={40} color="#ffffffbd" />
        </SocialMediaEntity>
        <SocialMediaEntity
        ...
        >
          <SocialMediaIcon name="instagram" size={40} color="#ffffffbd" />
        </SocialMediaEntity>
      </SocialMedia>
    </Container>
  );
