...
import Details from "../../components/ArtScreenComponents/Details/Details.component";
import Header from "../../components/ArtScreenComponents/Header/Header.comp";
...
const ArtScreen = ({ route }: { route: { params: { id: string } } }) => {
  ...
  return (
    <Container>
      <Header />
      <Details id={route.params.id} details={artDetails} />
    </Container>
  );
};
