...
import Header from "../../components/MyArtScreenComponents/Header/Header.component";
import MyArt from "../../components/MyArtScreenComponents/MyArt/MyArt.component";
import ArtForm from "../../components/MyArtScreenComponents/ArtForm/ArtForm.component";
...
const Wrapper = () => {
  return (
    ...
    >
      <Drawer.Screen name="MyArt" component={MyArtScreen} />
    </Drawer.Navigator>
  );
};
